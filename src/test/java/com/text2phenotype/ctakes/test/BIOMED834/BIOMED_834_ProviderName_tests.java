...
public class BIOMED_834_ProviderName_tests {
    ...
    public static Iterable<Object[]> samples() throws Exception  {
        ...
        Path samplesPath = Paths.get(FileLocator.getFullPath("BIOMED-834/provider/samples.bsv"));
    ...
    public void doTest() throws Exception {
        JCAS.reset();
        JCasSerializer.Load(JCAS, FileLocator.getFullPath("BIOMED-834/provider/dumps/" + Idx + ".xmi"));
        AE.process(JCAS);
        ...
        if (!isCorrect) {
            ...
            Assert.assertEquals("1578566626", mention.getCode());
        }
    }
}
